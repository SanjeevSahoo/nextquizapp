...
function Button(props: Props) {
  const { children, onClick, className, btnType, disabled, elementRef } = {
    onClick: () => null,
    className: "",
    btnType: "default",
    disabled: false,
  ...
  switch (btnType) {
    ...
    case "reset":
      backgroundClass =
        "text-blue-900 bg-gray-400 hover:text-white hover:bg-gray-500 dark:bg-gray-600 dark:text-white dark:hover:bg-gray-500";
      break;
    case "secondary":
      backgroundClass =
    ...
    case "error":
      backgroundClass =
        "text-blue-900 bg-red-400 hover:text-white hover:bg-gray-500 dark:bg-red-800 dark:text-white dark:hover:bg-gray-500";
      break;
    case "info":
      backgroundClass =
